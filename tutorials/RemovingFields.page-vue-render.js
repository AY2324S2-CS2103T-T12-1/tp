...
with(this){return _c('p',[_v("When working on an existing code base, you will most likely find that some features that are no longer necessary.\nThis tutorial aims to give you some practice on such a code 'removal' activity by removing the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("address")]),_v(" field from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Contact")]),_v(" class.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("A quick look at the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ContactCard")]),_v(" class and its "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("fxml")]),_v(" file quickly reveals why it slipped past the automated refactoring.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ContactCard.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ContactCard.fxml")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 21:48:50 GMT+8]")])])])}
}];
