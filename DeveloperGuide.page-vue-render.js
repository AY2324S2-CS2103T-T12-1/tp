...
with(this){return _c('h4',{attrs:{"id":"sequence-1"}},[_v("Sequence 1"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sequence-1","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"sequence-2"}},[_v("Sequence 2"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sequence-2","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"send-email-directly"}},[_v("Send Email Directly"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#send-email-directly","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Details:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("The user clicks on the email address of a contact in the contact list.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("handleEmailClicked()")]),_v(" method of the MailApp class is invoked.")]),_v(" "),_c('li',[_v("The MailApp class checks if the associated contact object and its email address are not null.")]),_v(" "),_c('li',[_v("If the email address is valid, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("openDefaultMailApp()")]),_v(" method is called with the email address as a parameter.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("openDefaultMailApp()")]),_v(" method attempts to open the default mail application with a new email composition window\naddressed to the recipient's email address.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("There can be a feature where multiple emails can be selected to send a mass email to them.")]),_v(" "),_c('li',[_v("There can be a check that ensures a valid email address has been input, following the correct format of what is expected\nof an email address.")])])}
},function anonymous(
) {
...
with(this){return _c('li',[_c('strong',[_v("JAR")]),_v(": A file that contains all the resources needed for CodeConnect to run.")])}
},function anonymous(
) {
with(this){return _c('li',[_c('strong',[_v("Java")]),_v(": A general-purpose programming language on which CodeConnect is built on.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a contact to empty list")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Clear the contact list using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(" command.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 g/johnDoee ts/Java")]),_c('br'),_v("\nExpected: Contact is added to the contact list with correct details. Details of added contact shown in status message.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding contact to non-empty list")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Contact list must be non-empty.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 g/betBetty t/criminal ts/Flutter")]),_c('br'),_v("\nExpected: Contact is added to the end of the contact list with correct details. Details of added contact shown in status message.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding invalid contact to empty list")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Clear the contact list using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(" command.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe")]),_c('br'),_v("\nExpected: Contact is not added to the contact list. Error message shown in status message.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding invalid contact to non-empty list")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Contact list must be non-empty.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/Betsy Crowe")]),_c('br'),_v("\nExpected: Contact is not added to the contact list. Error message shown in status message.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a contact while all contacts are being shown")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: First contact is deleted from the list. Details of the deleted contact shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No contact is deleted. Error details shown in the status message. Contact list remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete -1")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(", (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])])]),_v(" "),_c('li',[_c('p',[_v("Deleting a contact when list is empty")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: No contacts shown in filtered list. Use find command e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find someonethatdoesntexist")]),_v(" to show empty contact list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: No contact is deleted. Error details shown in the status message. Contact list remains the same.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Editing a contact while all contacts are being shown")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 ts/C ts/Java")]),_c('br'),_v("\nExpected: First contact's tech stacks are updated to contain "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("C")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")]),_v(". Details of edited contact shown in status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0 ts/C ts/Java")]),_c('br'),_v("\nExpected: No contact is edited. Error details shown in the status message. Contact list remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect edit commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 0")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 invalid/field")]),_c('br'),_v("\nExpected: Similar to previous.")])])])]),_v(" "),_c('li',[_c('p',[_v("Edited contact matches another existing contact in CodeConnect.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 2 n/SAME_NAME")]),_v(" (where SAME_NAME is the name of the first contact)"),_c('br'),_v("\nExpected: No contact is edited. Error details shown in the status message. Contact list remains the same.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-a-contact-by-name"}},[_v("Finding a contact by name"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-a-contact-by-name","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Searching for a contact with a single keyword")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list. In the following test\ncases, we assume we have contacts named "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Alex")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Bernice")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("David")]),_v(", and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find John")]),_c('br'),_v("\nExpected: The search should return contacts matching the keyword "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John")]),_v(". The search is case-insenstive and matches\nonly the name.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find XYZ")]),_c('br'),_v("\nExpected: The search should return no contacts since there are no matches for the keyword "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZ")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find BERNICE")]),_c('br'),_v("\nExpected: The search should return contacts matching the keyword "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("BERNICE")]),_v(" in a case-insensitive manner. It should\nmatch contacts with names like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Bernice")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("bernice")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("BERNICE")]),_v(", etc.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find Dav")]),_v("\nExpected: The search should return no contacts because the search only matches full keywords. Partial matches\nlike "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Dav")]),_v(" won't match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("David")]),_v(".")])])])]),_v(" "),_c('li',[_c('p',[_v("Searching for contacts with multiple keywords")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find alex david")]),_c('br'),_v("\nExpected: The search should return contacts matching either of the keywords "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("alex")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("david")]),_v(". The order of the\nkeywords do not matter, and partial matches will not be considered.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-a-contact-by-tag"}},[_v("Finding a contact by tag"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-a-contact-by-tag","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Finding a contact by tag while all contacts are shown")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list. In the following test\ncases, we assume we have contacts containing only the tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friend")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-tags friend")]),_c('br'),_v("\nExpected: All contacts with tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("friend")]),_v(" are shown in list. The search is case-insenstive and matches\nonly the tag.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-tags doesnotexist")]),_c('br'),_v("\nExpected: No contacts are shown in list.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect find tags command to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-tags")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-tags ")]),_c('br'),_v("\nExpected: No contact is found. Error details shown in the status message.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-a-contact-by-tech-stack"}},[_v("Finding a contact by tech stack"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-a-contact-by-tech-stack","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Finding a contact by tech stack while all contacts are shown")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list. In the following test\ncases, we assume we have contacts containing only the tech stack "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-ts Java")]),_c('br'),_v("\nExpected: All contacts with tech stack "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")]),_v(" are shown in list. The search is case-insenstive and matches\nonly the tech stack.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-ts doesnotexist")]),_c('br'),_v("\nExpected: No contacts are shown in list.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect find tech stack command to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-ts")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-ts ")]),_c('br'),_v("\nExpected: No contact is found. Error details shown in the status message.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"rating-a-contact-s-tech-stack"}},[_v("Rating a contact's tech stack"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#rating-a-contact-s-tech-stack","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Rating a contact's tech stack while all contacts are shown")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate 1 ts/Java r/8")]),_c('br'),_v("\nExpected: Tech stack "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")]),_v(" of contact at index "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("1")]),_v(" is rated with a rating "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("8")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate 0 ts/Java r/8")]),_c('br'),_v("\nExpected: Given tech stack of given contact is not rated. Error details shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect rate tech stack command to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate -1 ts/Java r/8")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate 1 ts/Java r/18")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate 1 ts/Java r/-8")]),_c('br'),_v("\nExpected: Given tech stack of given contact is not rated. Error details shown in the status message.")])])])]),_v(" "),_c('li',[_c('p',[_v("Rating a contact's tech stack when contact list is empty")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: No contacts shown in filtered list. Use find command e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find someonethatdoesntexist")]),_v(" to get empty list showing.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate 1 ts/Java r/8")]),_c('br'),_v("\nExpected: Given tech stack of given contact is not rated. Error details shown in the status message.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"adding-a-team"}},[_v("Adding a team"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-a-team","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a team")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Added team should not already exist in CodeConnect.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team add n/NUS HACK 2024")]),_c('br'),_v("\nExpected: Team is added to the team list. Details of team shown in status message.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding an invalid team")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Should be run after test case "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Adding a team")]),_v(". Team "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NUS HACK 2024")]),_v(" should exist in the team list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team add n/NUS HACK 2024")]),_c('br'),_v("\nExpected: No team is added. Error details shown in the status message. Team list remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team add")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team add NUS")]),_v("."),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"adding-members-to-a-team"}},[_v("Adding members to a team"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-members-to-a-team","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a contact to a team")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Ensure there are several contacts and teams in the list. A contact that needs to be added to a\nteam should not already be a member of that team.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 add-contact 1")]),_c('br'),_v("\nExpected: The contact at index 1 of the contact list should be added to the first team in the team list. After\nexecuting the command, verify that the contact is added to the team by entering "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 0 add-contact 1")]),_c('br'),_v("\nExpected: This command will return an error message indicating that the index is not a non-zero unsigned\ninteger. The contact will not be added to the team.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team add-contact 1")]),_c('br'),_v("\nExpected: This command will return an error message indicating that the team index provided is invalid as it does\nnot exist.")])])])]),_v(" "),_c('li',[_c('p',[_v("Adding a contact that is already in the team")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: View the members of the team with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team INDEX")]),_v(" command. Ensure that the contact already exists\nin the team. We assume contact 2 already exists in team 2 for the test case below.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 2 add-contact 2")]),_v("\nExpected: A message indicating that the contact already exists in the team is displayed.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"listing-members-of-a-team"}},[_v("Listing members of a team"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#listing-members-of-a-team","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("List members of a team")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Team list contains one or more teams. First team in list should have > 0 members.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1")]),_c('br'),_v("\nExpected: Contact list shows the members of the team. Team name correctly shown in status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 0")]),_c('br'),_v("\nExpected: Contact list does not change. Error details shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team X")]),_v(" (where X is greater than the last team's index)"),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"removing-members-from-a-team"}},[_v("Removing members from a team"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#removing-members-from-a-team","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a contact from a team")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Enter the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team INDEX")]),_v(" to ensure that there are serveral contacts in a team. A contact that\nneeds to be deleted should already be a member of that team.")])]),_v(" "),_c('li',[_c('p',[_v("Test Case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 delete-contact 1")]),_c('br'),_v("\nExpected: The contact at index 1 of the team's member list should be deleted from the first team in the team list.\nAfter executing the command, enter "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1")]),_v(" to ensure that the contact has been removed from the team.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 0 delete-contact 1")]),_c('br'),_v("\nExpected: This command will return an error message indicating that the index is not a non-zero unsigned\ninteger. The contact will not be deleted from the team.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 delete-contact 0")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team X delete-contact 1")]),_v(" (where X is greater than the last team's index)"),_c('br'),_v("\nExpected: This command will return an error message indicating that the team index provided is invalid as it does\nnot exist.")])]),_v(" "),_c('li',[_c('p',[_v("Similar incorrect commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 delete-contact 0")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 delete-contact X")]),_v(", (where X is greater than\nthe last team's index)"),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"exporting-team-details"}},[_v("Exporting team details"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#exporting-team-details","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Exporting team details")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Team list contains one or more teams. First team in list should have > 0 members.")])]),_v(" "),_c('li',[_c('p',[_v("Test Case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 export")]),_c('br'),_v("\nExpected Outcome: All team details are exported successfully to clipboard")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"deleting-a-team"}},[_v("Deleting a team"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleting-a-team","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a team")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Team list contains one or more teams.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 delete")]),_c('br'),_v("\nExpected: Team is deleted from the team list. Contact list does not change. Status message shows team name and its members.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 0 delete")]),_c('br'),_v("\nExpected: Team list does not change. Contact list does not change. Error details shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team X delete")]),_v(" (where X is greater than the last team's index)"),_c('br'),_v("\nExpected: Similar to previous.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"corrupted-or-missing-data-files"}},[_v("Corrupted or Missing Data files"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#corrupted-or-missing-data-files","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("Dealing with missing/corrupted data files")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("Prerequisites: Add a contact. Access addressbook.json and remove the name field from a address book. This simulates corrupt data. Restart the program to run into error.")])]),_v(" "),_c('li',[_c('p',[_v("Test Case: Delete addressbook.json and restart the app.\nExpected Outcome: A new addressbook.json is created.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 23:30:38 GMT+8]")])])])}
}];
