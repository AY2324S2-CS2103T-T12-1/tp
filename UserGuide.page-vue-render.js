...
with(this){return _c('p',[_v("Codeconnect is a "),_c('strong',[_v("developer-first networking app")]),_v(" for student developers to keep track of and reach out easily to other student developers, so they form teams for hackathons.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("We are "),_c('strong',[_v("optimized for use via a Line Interface")]),_v(" (CLI) while still having the benefits of a Graphical User Interface (GUI). If you can type fast, CC can get your contact management tasks done faster than traditional GUI apps.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("If you're already familiar with CodeConnect, you can skip ahead to the summary of features "),_c('a',{attrs:{"href":"#features"}},[_v("here")]),_v(", or to the command summary "),_c('a',{attrs:{"href":"#command-summary"}},[_v("here")]),_v(".\nIf you're new to CodeConnect, simply follow along step-by-step to discover how to gather and form your next champion team!")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"key-notes"}},[_v("Key Notes:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#key-notes","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("This is the text input area. This is the most important part of the program. Here is where you will key in the commands you need.\n"),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-input.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-input.png","alt":"quickstart-input.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is the file button. Here is where you can exit the program.\n"),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-file.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-file.png","alt":"quickstart-file.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is the help button. Here is where you can find any kind of help with CodeConnect.\n"),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-help.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-help.png","alt":"quickstart-help.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is our Team display panel. All the teams added are displayed here.\n"),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-teamlist.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-teamlist.png","alt":"quickstart-teamlist.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This si our response panel. It is where we provide responses to your CLI commands, or offer assistance.\n"),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-response.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-response.png","alt":"quickstart-response.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is our Contact display panel. This is where results of your searches for contacts will be displayed.\n"),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-personlist.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-personlist.png","alt":"quickstart-personlist.png"}})]),_v("~~")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Edits the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(". The index refers to the index number shown in the displayed contact list. The index "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, …​")]),_v(" "),_c('li',[_v("At least one of the optional fields must be provided.")]),_v(" "),_c('li',[_v("Existing values will be updated to the input values.")]),_v(" "),_c('li',[_v("When editing tags, the existing tags of the contact will be removed i.e adding of tags is not cumulative.")]),_v(" "),_c('li',[_v("You can remove all the contact’s tags and tech stack by typing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t/")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/ts")]),_v(" without\nspecifying any tags after it.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("The search is case-insensitive. e.g "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("school")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("School")])]),_v(" "),_c('li',[_v("Only the tags are searched.")]),_v(" "),_c('li',[_v("Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("school")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("schools")])]),_v(" "),_c('li',[_v("contacts matching all keywords will be returned (i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AND")]),_v(" search).")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("image to be replaced\n"),_c('a',{attrs:{"href":"/tp/images/findAlexDavidResult.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/findAlexDavidResult.png","alt":"result for 'find alex david'"}})])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("The search is case-insensitive. e.g "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")])]),_v(" "),_c('li',[_v("Only the tech stack are searched.")]),_v(" "),_c('li',[_v("Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("javascript")])]),_v(" "),_c('li',[_v("contacts matching all keywords will be returned (i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AND")]),_v(" search).")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("image to be inserted")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("The rating is case-sensitive. e.g "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")])]),_v(" "),_c('li',[_v("Only the tech stack in specified contact are searched.")]),_v(" "),_c('li',[_v("Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("javascript")])]),_v(" "),_c('li',[_v("Rating can only be between 0 and 10")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("image to be inserted")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_NAME")]),_v(" can only contain alphanumeric characters and spaces and cannot be blank.")]),_v(" "),_c('li',[_v("Each team in CodeConnect needs to have a unique name, so you can't add a team if another team with the same name is already present in the team list.")]),_v(" "),_c('li',[_v("Team names are case-sensitive, so it's fine to have two teams named "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NUS HACK 2024")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Nus Hack 2024")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Export the members' details of the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(".")]),_v(" "),_c('li',[_v("The index refers to the index number shown in the displayed teams list.")]),_v(" "),_c('li',[_v("The index "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, …​")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Deletes the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(".")]),_v(" "),_c('li',[_v("The index refers to the index number shown in the displayed teams list.")]),_v(" "),_c('li',[_v("The index "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, …​")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Adds the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" to the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(".")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(" refers to the index number shown in the displayed teams list.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" refers to the index number of the contact shown in the contact list the user sees.")]),_v(" "),_c('li',[_v("Both indexes must be positive integers.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Format: team "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(" delete-contact "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Deletes the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" from the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(".")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(" refers to the index number shown in the displayed teams list.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" refers to the index number of the contact shown in the contact list the user sees.")]),_v(" "),_c('li',[_v("Both indexes must be positive integers.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("How to use:")]),_v(" Use the up and down arrow keys to navigate through your history while the command input is focused.")])}
},function anonymous(
) {
