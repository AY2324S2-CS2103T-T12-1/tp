...
with(this){return _c('p',[_v("This is the text input area. This is the most important part of the program. Here is where you will key in the commands you need."),_c('br'),_v(" "),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-input.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-input.png","alt":"quickstart-input.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is the file button. Here is where you can exit the program."),_c('br'),_v(" "),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-file.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-file.png","alt":"quickstart-file.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is the help button. Here is where you can find any kind of help with CodeConnect."),_c('br'),_v(" "),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-help.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-help.png","alt":"quickstart-help.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is our teams display panel. All the teams added are displayed here."),_c('br'),_v(" "),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-teamlist.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-teamlist.png","alt":"quickstart-teamlist.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is our response panel. It is where we provide responses to your CLI commands, or offer assistance."),_c('br'),_v(" "),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-response.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-response.png","alt":"quickstart-response.png"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("This is our contacts display panel. This is where results of your searches for contacts will be displayed."),_c('br'),_v(" "),_c('a',{attrs:{"href":"/tp/images%2Fquickstart-personlist.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images%2Fquickstart-personlist.png","alt":"quickstart-personlist.png"}})])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('a',{attrs:{"href":"/tp/images/helpMessageUpdated.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/helpMessageUpdated.png","alt":"help message"}})])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Edits the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(". "),_c('br'),_v("\nℹ️ Existing values will be updated to the input values. "),_c('br'),_v("\nℹ️ When editing tags, the existing tags of the contact will be removed i.e. adding of tags is not cumulative. "),_c('br'),_v("\nℹ️ You can remove all the contact’s tags and tech stack by typing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("t/")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ts/")]),_v(" without\nspecifying any tags after it.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("⚠️ At least one of the optional fields must be provided. "),_c('br')])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ The search is case-insensitive. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("hans")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Hans")]),_v(" "),_c('br'),_v("\nℹ️ The order of the keywords does not matter. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Hans Bo")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Bo Hans")]),_v(" "),_c('br'),_v("\nℹ️ Only the name is searched. "),_c('br'),_v("\nℹ️ Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Han")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Hans")]),_v(" "),_c('br'),_v("\nℹ️ Contacts matching at least one keyword will be returned (i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("OR")]),_v(" search).\ne.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Hans Bo")]),_v(" will return "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Hans Gruber")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Bo Yang")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ The search is case-insensitive. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("school")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("School")]),_v(" "),_c('br'),_v("\nℹ️ Only the tags are searched. "),_c('br'),_v("\nℹ️ Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("school")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("schools")]),_v(" "),_c('br'),_v("\nℹ️ Contacts matching all keywords will be returned (i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AND")]),_v(" search).")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find-tags school")]),_v(" returns anyone with the tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("school")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ The search is case-insensitive. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")]),_v(" "),_c('br'),_v("\nℹ️ Only the tech stack are searched. "),_c('br'),_v("\nℹ️ Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("javascript")]),_v(" "),_c('br'),_v("\nℹ️ Contacts matching all keywords will be returned (i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AND")]),_v(" search).")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ The rating is case-sensitive. e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Java")]),_v(" "),_c('br'),_v("\nℹ️ Only supports the rating of 1 tech stack per command. "),_c('br'),_v("\nℹ️ Only the tech stack in specified contact are searched. "),_c('br'),_v("\nℹ️ Only full words will be matched e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java")]),_v(" will not match "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("javascript")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate 1 ts/Java r/8")]),_v(" rates the skill of Java of the first contact as 8.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Deletes the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(". "),_c('br'),_v("\nℹ️ The index refers to the index number shown in the displayed contact list.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Each team in CodeConnect needs to have a unique name, so you can't add a team if another team with the same name is\nalready present in the team list. "),_c('br'),_v("\nℹ️ Team names are case-sensitive, so it's fine to have two teams named "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("NUS HACK 2024")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Nus Hack 2024")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Export the members' details of the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(". "),_c('br'),_v("\nℹ️ The index refers to the index number shown in the displayed teams list.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Deletes the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(". "),_c('br'),_v("\nℹ️ The index refers to the index number shown in the displayed teams list. "),_c('br')])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Adds the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" to the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(". "),_c('br'),_v("\nℹ️ The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(" refers to the index number shown in the displayed teams list. "),_c('br'),_v("\nℹ️ The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" refers to the index number of the contact shown in the contact list the user sees.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 4 add-contact 1")]),_v(" adds the contact at index 1 of the contact list you are currently viewing to the fourth team in the team list.")]),_v(" "),_c('li',[_v("Enter "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 4")]),_v(" to view the updated members of the team.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Deletes the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" from the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(".\nℹ️ The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(" refers to the index number shown in the displayed teams list.\nℹ️ The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CONTACT_INDEX")]),_v(" refers to the index number of the contact shown in the contact list the user sees.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1 delete-contact 3")]),_v(" deletes the contact at index 3 from the first team in the team list.")]),_v(" "),_c('li',[_v("Enter "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("team 1")]),_v(" to view the updated members of the team.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("ℹ️ Export the members' details of the team at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TEAM_INDEX")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("NAME")]),_v(": Must contain alphanumeric characters and may include spaces. All names must be unique.")]),_v(" "),_c('li',[_c('strong',[_v("ADDRESS")]),_v(": Can contain any value.")]),_v(" "),_c('li',[_c('strong',[_v("PHONE NUMBER")]),_v(": Must contain only numbers and should be at least 3 digits long.")]),_v(" "),_c('li',[_c('strong',[_v("EMAIL ADDRESS")]),_v(": Can contain any values. "),_c('br'),_v("\nℹ️ While the email address field accepts any values, it is important to adhere to the following:\n"),_c('ul',[_c('li',[_v("The local-part before the '@' symbol can only contain alphanumeric characters and the special characters +_.-.")]),_v(" "),_c('li',[_v("The local-part cannot start or end with any special characters.")]),_v(" "),_c('li',[_v("After the '@' symbol, there should be a domain name composed of domain labels separated by periods.")]),_v(" "),_c('li',[_v("The domain name must end with a label containing at least 2 characters.")]),_v(" "),_c('li',[_v("Each domain label should start and end with alphanumeric characters, and consist only of alphanumeric characters\nwith hyphens allowed as separators, if necessary.")])])]),_v(" "),_c('li',[_c('strong',[_v("GITHUB USERNAME")]),_v(": Can contain only alphanumeric characters and hyphens(-). All GitHub usernames must be unique.")]),_v(" "),_c('li',[_c('strong',[_v("PROFILE PICTURE")]),_v(": Must be a valid URI to an image. Supports png, jpg, jpeg and gif formats.")]),_v(" "),_c('li',[_c('strong',[_v("TAGS")]),_v(": Must contain alphanumeric characters only. They are limited to only 15 characters.")]),_v(" "),_c('li',[_c('strong',[_v("TECH STACK")]),_v(": Can contain alphanumeric characters, underscores(_), hashtags(#), hyphens(-), periods(.) and plus signs(+).\nThey are limited to only 15 characters. "),_c('br'),_v("\n⚠️ If you are entering the tech stack for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("rate")]),_v(" command, please ensure it is the tech stack that the specified index has.")]),_v(" "),_c('li',[_c('strong',[_v("INDEX/CONTACT_INDEX")]),_v(": Must be a positive integer which is not greater than the number of contacts the user is currenty seeing in the\ncontact list.")]),_v(" "),_c('li',[_c('strong',[_v("RATING")]),_v(": Must be an integer between 0 (inclusive) and 10 (inclusive).")]),_v(" "),_c('li',[_c('strong',[_v("TEAM NAME")]),_v(": Can only contain alphanumeric characters and spaces. All team names must be unique.")]),_v(" "),_c('li',[_c('strong',[_v("TEAM INDEX")]),_v(": Must be a positive integer which is not greater than the number of teams in the address book.")])])}
},function anonymous(
) {
