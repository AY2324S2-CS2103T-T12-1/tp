...
public class UniqueTeamList implements Iterable<Team> {
    ...
    /**
     * Adds the given contact to the specified team.
     * The contact must not already exist in the team.
     * The team must exist in the list.
     */
    public void addContactToTeam(Team team, Contact contact) {
        ...
        Team existingTeam = internalList.stream()
                .filter(team::equals)
                .findFirst()
                .orElseThrow(TeamNotFoundException::new);

        // Add the contact to the team
        existingTeam.addMember(contact);
    }

    /**
     * Deletes the given contact from the specified team.
     * The contact must already exist in the team.
     * The team must exist in the list.
     */
    public void deleteContactFromTeam(Team team, Contact contact) {
        ...
        // Delete the contact from the team
        existingTeam.deleteMember(contact);
    }
