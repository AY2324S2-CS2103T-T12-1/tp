 ...
 * A contact is considered unique by comparing using {@code Contact#isSamePerson(Contact)}.
 * As such, adding and updating of persons uses Contact#isSamePerson(Contact) for equality
 * to ensure that the contact being added or updated is unique in terms of identity
 * in the UniqueContactList. However, the removal of a contact uses Contact#equals(Object)
