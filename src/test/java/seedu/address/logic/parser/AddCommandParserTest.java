...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GITHUB_USERNAME_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                new AddCommand(expectedContactMultipleTags));

        // multiple tech stacks - all accepted
        Contact expectedPersonMultipleTechStacks = new ContactBuilder(BOB).withTechStack(VALID_TECH_STACK_PYTHON,
                        VALID_TECH_STACK_JAVA)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + GITHUB_USERNAME_DESC_BOB + TECH_STACK_DESC_PYTHON + TECH_STACK_DESC_JAVA + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND,
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_GITHUB_USERNAME, PREFIX_ADDRESS,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GITHUB_USERNAME_DESC_BOB
        ...
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + GITHUB_USERNAME_DESC_BOB
                + VALID_TECH_STACK_PYTHON + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + GITHUB_USERNAME_DESC_BOB
                + VALID_TECH_STACK_PYTHON + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + GITHUB_USERNAME_DESC_BOB
                + VALID_TECH_STACK_PYTHON + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid github username
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_GITHUB_USERNAME_DESC + VALID_TECH_STACK_PYTHON + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, GitHubUsername.MESSAGE_CONSTRAINTS);

        // invalid tech stack
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GITHUB_USERNAME_DESC_BOB + INVALID_TECH_STACK_DESC + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, TechStack.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GITHUB_USERNAME_DESC_BOB + VALID_TECH_STACK_PYTHON + INVALID_TAG_DESC
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + INVALID_PHONE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GITHUB_USERNAME_DESC_BOB + VALID_TECH_STACK_PYTHON + TAG_DESC_HUSBAND
                + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + GITHUB_USERNAME_DESC_BOB + VALID_TECH_STACK_PYTHON
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
